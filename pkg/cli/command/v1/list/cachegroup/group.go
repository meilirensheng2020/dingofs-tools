...
type CacheGroupCommand struct {
	...
	Rpc      *common.ListCacheGroupRpc
	response *pbCacheGroup.LoadMembersResponse
}
...
func (cacheGroup *CacheGroupCommand) RunCommand(cmd *cobra.Command, args []string) error {
	...
	rpc := &common.ListCacheGroupRpc{
		Info:    rpcInfo,
		Request: &pbCacheGroup.LoadGroupsRequest{},
	}
	...
	result := response.(*pbCacheGroup.LoadGroupsResponse)
