...
import (
	...
	"github.com/dingodb/dingofs-tools/pkg/cli/command/v1/query/dirtree"
	"github.com/dingodb/dingofs-tools/pkg/cli/command/v1/query/fs"
	"github.com/dingodb/dingofs-tools/pkg/cli/command/v1/query/inode"
	"github.com/dingodb/dingofs-tools/pkg/cli/command/v1/query/metaserver"
	"github.com/dingodb/dingofs-tools/pkg/cli/command/v1/query/partition"
