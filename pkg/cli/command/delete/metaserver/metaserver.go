...
var _ basecmd.RpcFunc = (*DeleteMetaServerRpc)(nil) // check interface
...
func (metaServerCmd *DeleteMetaServerCommand) Init(cmd *cobra.Command, args []string) error {
	...
	metaServerCmd.Rpc.Info = basecmd.NewRpc(addrs, timeout, retrytimes, "DeleteMetaServer")
...
func (metaServerCmd *DeleteMetaServerCommand) RunCommand(cmd *cobra.Command, args []string) error {
	...
	result, err := basecmd.GetRpcResponse(metaServerCmd.Rpc.Info, metaServerCmd.Rpc)
