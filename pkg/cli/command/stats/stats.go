...
var _ basecmd.FinalDingoCmdFunc = (*StatsCommand)(nil) // check interface
...
func (statsCmd *StatsCommand) Print(cmd *cobra.Command, args []string) error {
	return output.FinalCmdOutput(&statsCmd.FinalDingoCmd, statsCmd)
}

func (statsCmd *StatsCommand) ResultPlainOutput() error {
	return output.FinalCmdOutputPlain(&statsCmd.FinalDingoCmd)
}
