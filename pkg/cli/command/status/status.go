...
import (
	...
	"github.com/dingodb/dingofs-tools/pkg/cli/command/status/cluster"
	"github.com/dingodb/dingofs-tools/pkg/cli/command/status/copyset"
	etcd "github.com/dingodb/dingofs-tools/pkg/cli/command/status/etcd"
	mds "github.com/dingodb/dingofs-tools/pkg/cli/command/status/mds"
	"github.com/dingodb/dingofs-tools/pkg/cli/command/status/metaserver"
