...
protoc --go_out=proto --proto_path=./third-party \
    --go_opt=Mdingofs/proto/common.proto=github.com/dingodb/dingofs-tools/proto/dingofs/proto/common \
...
protoc --go_out=proto --proto_path=./third-party \
    --go_opt=Mdingofs/proto/common.proto=github.com/dingodb/dingofs-tools/proto/dingofs/proto/common \
    --go_opt=Mdingofs/proto/topology.proto=github.com/dingodb/dingofs-tools/proto/dingofs/proto/topology \
...
# grpc
## fs
protoc --go-grpc_out=proto --proto_path=./third-party ./third-party/dingofs/proto/*.proto